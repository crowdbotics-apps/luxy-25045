...
admin.site.site_header = "luxy"
admin.site.site_title = "luxy Admin Portal"
admin.site.index_title = "luxy Admin"

# swagger
api_info = openapi.Info(
    title="luxy API",
    default_version="v1",
    description="API documentation for luxy App",
)
